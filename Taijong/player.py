...
class Player:
    ...
    def check_jia_kong(self, tile):
        count_openhand = self.openhand.count(tile)
        if count_openhand == 3:
    ...
    def do_discard(self, tile_index):
        ...
        self.discardhand.append(discard_tile)
    ...
    def do_chow(self, decision):
        ...
        if decision in [2, 3, 4]:
            ...
            if decision == 2:
                temp = self.openhand[-2]
                self.openhand[-2] = self.openhand[-3]
                self.openhand[-3] = temp
            elif decision == 4:
                temp = self.openhand[-2]
                self.openhand[-2] = self.openhand[-1]
                self.openhand[-1] = temp
            return True
        return False
    ...
    #             # 2, 3, 4 -> == [] -> invalid -> redecision
    #             for i in range(3):
    #                 self.openhand.append(Chow_decison_set[decision-2][i])   # Append Chow set into the player's open hand

    #                 hand.remove(Chow_decison_set[decision-2][i])
    #             return True
...
# player.check_pong(2)
# print(player.hand)
# print(player.openhand)
# player.check_chow(15)